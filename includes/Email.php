...
class Email {
	...
	public function register(): void {
		add_action( 'wdcy_weekly_decay_scan', array( $this, 'maybe_send_digest' ) );
	}
	...
	public function send_digest(): bool {
		...
		$subject = sprintf(
			...
			__( '[%s] Weekly Content Decay Report', 'decaywatcher' ),
			get_bloginfo( 'name' )
		);
	...
	private function build_email_body( array $snapshots ): string {
		...
		$report_link = '<a href="' . $report_url . '">' . esc_html__( 'View Full Report', 'decaywatcher' ) . '</a>';
